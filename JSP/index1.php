...
foreach ($faq as $key => $value) {
    ...
    echo '<a href="#demo'.$key.'" class="btn btn-primary" data-toggle="collapse" data-target="#demo'.$key.'">'.nl2br(htmlspecialchars( $value['nom'])).'</a>';

    echo  '<div id="demo'.$key.'" class="collapse show ">'.nl2br(htmlspecialchars($value['poste'])).'<br><br></div>';
